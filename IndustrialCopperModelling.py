...
def selling_price():
    ...
    if button:
        ...
        with open(r"D:/Project/IndustrialCopperModelling/selling_price_regressor_model.pkl", 'rb') as f:    # Adjust the file path as per your saved model
        ...
        st.write(np.array([[quantity, customer, country, status_int, item_type_int, 
                                application, thickness, width, product_ref,duration_days]]))
        # Make predictions
        y_pred = selling_price_model.predict(np.array([[quantity, customer, country, status_int, item_type_int, 
                                application, thickness, width, product_ref,duration_days]]))
        selling_price = y_pred[0]  # Apply exponential to get back original scale
...
def status():
    ...
    if button: 
        ...
        with open(r"D:/Project/IndustrialCopperModelling/status_classification_model.pkl", 'rb') as f:     # Adjust the file path as per your saved model
        ...
        # Make predictions
        y_pred = status_model.predict(np.array([[quantity, customer, country, item_type_int, application, thickness, width, product_ref, selling_price,duration_days]]))
