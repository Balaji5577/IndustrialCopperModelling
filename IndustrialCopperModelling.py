...
def selling_price():
    ...
    if button:
        ...
        with open(r"D:/Project/IndustrialCopperModelling/selling_price_newmodel.pkl", 'rb') as f:    # Adjust the file path as per your saved model
...
def status():
    ...
    if button: 
        ...
        with open(r"D:/Project/IndustrialCopperModelling/status_newmodel.pkl", 'rb') as f:     # Adjust the file path as per your saved model
